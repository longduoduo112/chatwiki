...
<template>
  <div class="">
    <a-alert class="tip-alert zm-alert-info" type="info" show-icon>
      <template #message>LINE是韩国互联网集团NHN的日本子公司NHN Japan推出的一款即时通讯软件，渠道接入后可以统一接收和回复消息</template>
    </a-alert>
    ...
    <AddLineAlert ref="addAppAlertRef" @ok="onSaveSuccess" />
  </div>
</template>
...
import AddLineAlert from "./add-line-alert.vue";
